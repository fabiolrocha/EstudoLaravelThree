                                ...
                                <td class="py-3 px-4 align-middle">
                                    <div class="flex gap-2 justify-center">
                                        ...
                                        <form method="POST" action="{{ route('clients.destroy', $client) }}" class="inline">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                    class="inline-flex items-center px-3 py-1.5 bg-red-600 text-white text-xs font-medium rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors duration-200"
